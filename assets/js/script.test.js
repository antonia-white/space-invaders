...
// When user clicks sound button, toggle sound
volumeBtn.addEventListener('click', function() {
    if (volumeBtn.style.backgroundImage == 'url("../assets/media/audio-off.png")') {
        volumeBtn.style.backgroundImage = 'url("../assets/media/audio-on.png")';
    }
    else if (volumeBtn.style.backgroundImage == 'url("../media/audio-off.png")') {
        volumeBtn.style.backgroundImage = 'url("../assets/media/audio-on.png")';
    }
    else {
        volumeBtn.style.backgroundImage = 'url("../assets/media/audio-off.png")';
    }
})

// volumeBtn.addEventListener('click', function() {
//     if(volumeBtn.style.backgroundImage == 'url("../assets/media/audio-off.png")' || 'url("../media/audio-off.png")') {
//         volumeBtn.style.backgroundImage = 'url("../assets/media/audio-on.png")';
//     }
//     else if (volumeBtn.style.backgroundImage == 'url("../assets/media/audio-on.png")') {
//         volumeBtn.style.backgroundImage = 'url("../media/audio-off.png")';
//     }
// }
// )
